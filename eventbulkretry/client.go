...
func (c *Client) List(ctx context.Context, request *hookdeckgosdk.EventBulkRetryListRequest) (*hookdeckgosdk.BatchOperationPaginatedResult, error) {
	baseURL := "https://api.hookdeck.com"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "2023-07-01/bulk/events/retry"
...
func (c *Client) Create(ctx context.Context, request *hookdeckgosdk.EventBulkRetryCreateRequest) (*hookdeckgosdk.BatchOperation, error) {
	baseURL := "https://api.hookdeck.com"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
...
func (c *Client) Plan(ctx context.Context) (*hookdeckgosdk.EventBulkRetryPlanResponse, error) {
	baseURL := "https://api.hookdeck.com"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "2023-07-01/bulk/events/retry/plan"
...
func (c *Client) Retrieve(ctx context.Context, id string) (*hookdeckgosdk.BatchOperation, error) {
	...
	endpointURL := fmt.Sprintf(baseURL+"/"+"2023-07-01/bulk/events/retry/%v", id)
...
func (c *Client) Cancel(ctx context.Context, id string) (*hookdeckgosdk.BatchOperation, error) {
	...
	endpointURL := fmt.Sprintf(baseURL+"/"+"2023-07-01/bulk/events/retry/%v/cancel", id)
